...
var (
	...
	NetBoxFieldCPUThreads     = getEnvOrDefault("NETBOX_FIELD_CPU_THREADS", "hw_cpu_threads")
	NetBoxFieldCPUSpeedMHz    = getEnvOrDefault("NETBOX_FIELD_CPU_SPEED", "hw_cpu_speed_mhz")
